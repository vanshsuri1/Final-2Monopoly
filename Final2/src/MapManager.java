...
public class MapManager {
	...
	private static final String[] LABELS = { "GO", "ME", "CC1", "BA", "IT", "RR1", "OR", "CH1", "VE", "CT", "JZ", "ST",
			"EC", "ST2", "VA", "RR2", "SJ", "CC2", "TN", "NY", "FP", "KY", "CH2", "IN", "IL", "RR3", "AT", "VE2", "WW",
			"MR", "GT", "PA", "NC", "CC3", "PE", "RR4", "CH3", "PK", "LT", "BW" };

	/* ---------- FULL NAMES (made public for stats screen) ---------- */
	public static final String[] NAMES = { "Go", "Mediterranean Avenue", "Community Chest 1", "Baltic Avenue",
			"Income Tax", "Reading Railroad", "Oriental Avenue", "Chance 1", "Vermont Avenue", "Connecticut Avenue",
			"Just Visiting / In Jail", "St. Charles Place", "Electric Company", "States Avenue", "Virginia Avenue",
			"Pennsylvania Railroad", "St. James Place", "Community Chest 2", "Tennessee Avenue", "New York Avenue",
			"Free Parking", "Kentucky Avenue", "Chance 2", "Indiana Avenue", "Illinois Avenue", "B. & O. Railroad",
			"Atlantic Avenue", "Ventnor Avenue", "Water Works", "Marvin Gardens", "Go To Jail", "Pacific Avenue",
			"North Carolina Avenue", "Community Chest 3", "Pennsylvania Avenue", "Short Line Railroad", "Chance 3",
