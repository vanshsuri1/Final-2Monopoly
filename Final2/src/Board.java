public class Board {
	...
	static {
		...
		properties[24] = new Property("Illinois", 240, 150, new int[] { 20, 100, 300, 750, 925, 1100 }, 120,
				"property");
		properties[26] = new Property("Atlantic", 260, 150, new int[] { 22, 110, 330, 800, 975, 1150 }, 130,
				"property");
		properties[27] = new Property("Ventnor", 260, 150, new int[] { 22, 110, 330, 800, 975, 1150 }, 130, "property");
		properties[29] = new Property("MarvinGardens", 280, 150, new int[] { 24, 120, 360, 850, 1025, 1200 }, 140,
				"property");
		properties[31] = new Property("Pacific", 300, 200, new int[] { 26, 130, 390, 900, 1100, 1275 }, 150,
				"property");
		properties[32] = new Property("NorthCarolina", 300, 200, new int[] { 26, 130, 390, 900, 1100, 1275 }, 150,
				"property");
		properties[34] = new Property("Pennsylvania", 320, 200, new int[] { 28, 150, 450, 1000, 1200, 1400 }, 160,
				"property");
		properties[37] = new Property("ParkPlace", 350, 200, new int[] { 35, 175, 500, 1100, 1300, 1500 }, 175,
				"property");
		properties[39] = new Property("Boardwalk", 400, 200, new int[] { 50, 200, 600, 1400, 1700, 2000 }, 200,
				"property");
